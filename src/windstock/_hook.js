...
// hook.js
init_node_globals();
var Java = (init_frida_java_bridge(), __toCommonJS(frida_java_bridge_exports)).default;
function libDir() {
  try {
...
Java.perform(function() {
  ...
  try {
    ...
    Runtime2.load0.overload("java.lang.Class", "java.lang.String").implementation = function(cls, name) {
      return this.load0(cls, fix(name));
    };
