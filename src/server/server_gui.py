"""
Windstock -- the game server's own window.
...
# header rides out a Windstock Storm for a few seconds.
EGG_WORD = "WINDSTOCK"
EGG_ART = r"""
...
EGG_LINES = [
    ...
    "⚡ A Windstock Storm rolls in over the server…",
...
class Humanizer:
    ...
    # A request batch: "06:35:58  [windstock67]  SET_AVATAR, CHECK_CHALLENGE, ...".
...
class ServerWindow:
    def __init__(self, root):
        ...
        root.title("Windstock \u2014 Pok\u00e9mon GO Server")
    ...
    def _build(self):
        ...
        self.title_lbl = tk.Label(titles, text="WINDSTOCK", bg="white", fg=BLUE,
    ...
    def _flash(self, n):
        ...
        self.state_lbl.configure(
            text="⚡ WINDSTOCK STORM" if n % 2 == 0 else "● WINDSTOCK STORM", fg=c)
